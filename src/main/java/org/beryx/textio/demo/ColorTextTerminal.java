...
public class ColorTextTerminal extends JLineTextTerminal {
    private static final Logger logger =  LoggerFactory.getLogger(ColorTextTerminal.class);
    ...
    public ColorTextTerminal() {
        super(createReader());
    }

    @Override
    public void rawPrint(String message) {
        super.rawPrint("\u001B[1;32m" + message + "\u001B[0m");
    }
}
